<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="product.aspx.cs" Inherits="demo.WebForm4" %>
                      ...
                      <div class="grid__column10">
                          ...
                          <div class="home_products">
                              <div class="grid__row1">
                                  ...
                                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:usesConnectionString %>" SelectCommand="SELECT * FROM [sanpham]" FilterExpression="sanpham like '%{0}%'"
                                  >
                                      <FilterParameters>
                                          <asp:ControlParameter  ControlID="txt_uses_search" Name="sanpham" Direction="Input" PropertyName="Text" />
                                      </FilterParameters>
                                  </asp:SqlDataSource>
